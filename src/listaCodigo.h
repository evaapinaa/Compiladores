...
- op: código de operación, como "add", "mv", "mul", etc.
- arg1: argumento 1 de la operación, como "$t3", etc.
- arg2: argumento 2 de la operación, como "$t7", etc.
- res: resultado de la operación, como "$t2", etc.
