...
{
       0,    66,    66,    66,    77,    76,    83,    82,    88,    91,
      93,    99,   105,   120,   123,   126,   142,   144,   177,   195,
     226,   227,   230,   231,   234,   256,   274,   296,   320,   332,
     344,   356,   368,   377,   378,   387
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "PRINT", "READ", "PCOMMA", "COMMA", "PLUSOP", "MINUSOP",
  "ASTER", "BARRA", "ASSIG", "PARD", "PARI", "CORI", "CORD", "ID", "CADE",
  "ENT", "NEG", "$accept", "program", "$@1", "declarations", "$@2", "$@3",
...
{
     -53,     5,    14,   -53,    12,    10,    28,    32,   -53,     7,
     -53,   -53,    -2,    26,    26,    41,    47,    31,    50,   -53,
     -53,    72,   -53,    74,     4,   -53,    11,    37,    37,    37,
      37,   -53,   -53,   -53,    46,   -53,    25,   -53,    73,    22,
      37,    37,   -53,    26,   -53,    49,    55,   -53,    61,   -53,
      31,    37,    37,    37,    37,   -53,    66,   -53,    67,    25,
     -53,    27,    27,   -53,   -53,    71,    71,   -53,   -53,   -53,
     -53,    83,   -53,    27,   -53
};
...
static const yytype_int8 yydefact[] =
{
       ...
       3,     0,    13,    11,     0,     9,     0,     0,     0,     0,
       0,    34,    25,    35,     0,    22,    24,    26,     0,     0,
       0,     0,     5,     0,     7,     0,     0,    32,     0,    20,
       0,     0,     0,     0,     0,    21,     0,    16,     0,    12,
      10,     0,     0,    33,    23,    28,    29,    30,    31,    27,
      15,    18,    19,     0,    17
};
...
{
      45,    46,    47,    48,    15,     3,    16,    17,    18,    71,
      72,    10,    11,    58,    59,    42,    43,     4,    19,    20,
      21,    74,    44,    43,    65,    66,    67,    68,    15,     6,
      16,    17,    18,    15,     5,    16,    17,    18,    51,    52,
      53,    54,    19,    57,    21,    29,     7,    19,    23,    21,
      30,    29,     8,    31,    32,    33,    30,    49,    50,    31,
      27,    33,    51,    52,    53,    54,    28,    61,    51,    52,
      53,    54,    37,    62,    51,    52,    53,    54,    70,    63,
      51,    52,    53,    54,    55,    56,    53,    54,    69,    40,
      73,    41,    26,    64,    60,    39
};

static const yytype_int8 yycheck[] =
{
      27,    28,    29,    30,     6,     0,     8,     9,    10,    61,
      62,     4,     5,    40,    41,    11,    12,     3,    20,    21,
      22,    73,    11,    12,    51,    52,    53,    54,     6,    19,
       8,     9,    10,     6,    22,     8,     9,    10,    13,    14,
      15,    16,    20,    21,    22,    14,    18,    20,    22,    22,
      19,    14,    20,    22,    23,    24,    19,    11,    12,    22,
      19,    24,    13,    14,    15,    16,    19,    18,    13,    14,
      15,    16,    22,    18,    13,    14,    15,    16,    11,    18,
      13,    14,    15,    16,    11,    12,    15,    16,    22,    17,
       7,    17,    14,    50,    43,    19
};
...
{
       0,    27,    28,     0,     3,    22,    19,    18,    20,    29,
       4,     5,    34,    30,    31,     6,     8,     9,    10,    20,
      21,    22,    35,    22,    32,    33,    32,    19,    19,    14,
      19,    22,    23,    24,    36,    37,    39,    22,    38,    34,
      17,    17,    11,    12,    11,    39,    39,    39,    39,    11,
      12,    13,    14,    15,    16,    11,    12,    21,    39,    39,
      33,    18,    18,    18,    37,    39,    39,    39,    39,    22,
      11,    35,    35,     7,    35
};
...
#line 1476 "miniC.tab.c"
  ...
  case 11:
#line 100 "miniC.y"
                                { if (!ContieneSimbolo((yyvsp[0].string))){
					AnadirSimbolo((yyvsp[0].string), tipo);}
...
#line 1486 "miniC.tab.c"
  ...
  case 12:
#line 106 "miniC.y"
                                {if (!ContieneSimbolo((yyvsp[-2].string))) AnadirSimbolo((yyvsp[-2].string), tipo);
				else{
				...
				Operacion opera;
				opera.op = "sw";
				opera.res = recuperaResLC((yyvsp[0].codigo));
				opera.arg1 = enlazar_cadena("_",(yyvsp[-2].string));
				opera.arg2 = NULL;
				insertaLC((yyval.codigo),finalLC((yyval.codigo)),opera);
...
#line 1516 "miniC.tab.c"
  ...
  case 15:
#line 127 "miniC.y"
                                {if (!ContieneSimbolo((yyvsp[-3].string))){
					numErroresSemanticos++;
					printf("Error semántico en la linea %d: \"%s\" no está declarada\n", yylineno, (yyvsp[-3].string));} else { 
					if (AnalizaConstantes((yyvsp[-3].string))){
					numErroresSemanticos++;
					printf("Error semántico en la linea %d: \"%s\" es una constante\n", yylineno, (yyvsp[-3].string));}}
				(yyval.codigo) = (yyvsp[-1].codigo);
				Operacion opera;
				opera.op = "sw";
				opera.res = recuperaResLC((yyvsp[-1].codigo));
				opera.arg1 = enlazar_cadena("_",(yyvsp[-3].string));
				opera.arg2 = NULL;
				insertaLC((yyval.codigo), finalLC((yyval.codigo)), opera);
				liberarReg(opera.res);	
				}
...
#line 145 "miniC.y"
				...
				Operacion opera;
				opera.op = "beqz";
				opera.res = recuperaResLC((yyvsp[-4].codigo));
				opera.arg1 = etiq;
				opera.arg2 = NULL;
				insertaLC((yyval.codigo),finalLC((yyval.codigo)),opera);
...
#line 178 "miniC.y"
				...
				Operacion opera;
				opera.op = "beqz";
				opera.res = recuperaResLC((yyvsp[-2].codigo));
				opera.arg1 = etiq;
				opera.arg2 = NULL;
				insertaLC((yyval.codigo), finalLC((yyval.codigo)), opera);
				concatenaLC((yyval.codigo), (yyvsp[0].codigo));
...
#line 235 "miniC.y"
				...
				opera.op = "move";
				opera.res = "$a0";
				opera.arg1 = recuperaResLC((yyvsp[0].codigo));
				opera.arg2 = NULL;
...
#line 1674 "miniC.tab.c"
  ...
  case 25:
#line 257 "miniC.y"
                                {AnadirSimbolo((yyvsp[0].string), CADENA);
				(yyval.codigo) = creaLC();
...
#line 1694 "miniC.tab.c"
  ...
  case 26:
#line 275 "miniC.y"
                                {if (!ContieneSimbolo((yyvsp[0].string))){printf("La variable %s en la linea %d no esta declarada \n",(yyvsp[0].string),yylineno); numErroresSemanticos++;}
				else if(AnalizaConstantes((yyvsp[0].string))){printf("La variable %s de la linea %d es una constante (Asignacion a constante) \n", (yyvsp[0].string), yylineno); numErroresSemanticos++;}
				(yyval.codigo)=creaLC();
				Operacion opera;
				opera.op = "li";
				opera.res = "$v0";
				...
				opera.op = "sw";
				opera.res = "$v0";
				opera.arg1 = enlazar_cadena("_",(yyvsp[0].string));
				opera.arg2 = NULL;
				insertaLC((yyval.codigo),finalLC((yyval.codigo)),opera);}
...
#line 320 "miniC.y"
						...
						opera.arg1 = recuperaResLC((yyvsp[-2].codigo));
						opera.arg2 = recuperaResLC((yyvsp[0].codigo));
						insertaLC((yyval.codigo),finalLC((yyval.codigo)),opera);
						liberaLC((yyvsp[0].codigo));
						guardaResLC((yyval.codigo),opera.res);
